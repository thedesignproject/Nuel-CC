...
// ============================================
// SAMPLE DATA - Generic Supply Chain Orders
// ============================================

const ORDERS_DATA: OrderRow[] = [
  // Page 1 - Raw Materials & Components
  {
    ...
    creator: 'RMA',
    customer: 'Nashville Facility',
    customerCode: 'NF-2045',
    shipTo: 'Production Facility',
    deliveryCity: 'Nashville',
    deliveryState: 'TN',
    material: 'Raw Material A',
    materialCode: 'RM-A-001',
    volume: 28.5,
    optimizedSource: 'Central Facility',
    sourceType: 'plant',
  ...
  },
  {
    ...
    creator: 'RMB',
    customer: 'Los Angeles Facility',
    customerCode: 'LAF-3821',
    shipTo: 'West Coast Hub',
    deliveryCity: 'Los Angeles',
    deliveryState: 'CA',
    material: 'Raw Material B',
    materialCode: 'RM-B-002',
    volume: 35.2,
    optimizedSource: 'Southern Terminal',
    sourceType: 'terminal',
    status: 'In Transit',
  ...
  },
  {
    ...
    materialCode: 'CP-C-003',
    volume: 8.4,
    optimizedSource: 'Midwest Processing',
    sourceType: 'plant',
    status: 'Delivered',
    statusVariant: 'good',
  ...
  },
  {
    ...
    creator: 'CPD',
    customer: 'Central Facility',
    customerCode: 'CF-5502',
    shipTo: 'Processing Plant',
    deliveryCity: 'Des Moines',
    deliveryState: 'IA',
    material: 'Component D',
    materialCode: 'CP-D-004',
    volume: 12.8,
    optimizedSource: 'Southern Terminal',
    sourceType: 'terminal',
  ...
  },
  {
    ...
    deliveryState: 'TN',
    material: 'Additive E',
    materialCode: 'AD-E-005',
    volume: 4.2,
    optimizedSource: 'Eastern Plant',
    sourceType: 'plant',
    status: 'Processing',
    statusVariant: 'info',
    actionLabel: 'Accepted',
  ...
  },
  {
    ...
    customer: 'Los Angeles Facility',
    customerCode: 'LAF-3821',
    shipTo: 'Storage Facility',
    deliveryCity: 'Los Angeles',
    deliveryState: 'CA',
    material: 'Additive F',
    materialCode: 'AD-F-006',
    volume: 6.5,
    optimizedSource: 'Eastern Terminal',
    sourceType: 'terminal',
    status: 'FM Assigned',
    statusVariant: 'warning',
  ...
  },
  {
    ...
    creator: 'ADE',
    customer: 'Seattle Facility',
    customerCode: 'SEA-7712',
    shipTo: 'Processing Center',
    deliveryCity: 'Seattle',
    deliveryState: 'WA',
    material: 'Additive E',
    materialCode: 'AD-E-005',
    volume: 5.8,
    optimizedSource: 'Southeastern Plant',
    sourceType: 'plant',
    status: 'Pending',
    statusVariant: 'warning',
    actionLabel: 'Review',
  ...
  },
  {
    ...
    creator: 'CPH',
    customer: 'Denver Facility',
    customerCode: 'DEN-4420',
    shipTo: 'Specialty Line',
    deliveryCity: 'Denver',
    deliveryState: 'CO',
    material: 'Compound H',
    materialCode: 'CM-H-008',
    volume: 4.5,
    optimizedSource: 'Regional Hub',
    sourceType: 'terminal',
    status: 'Pending',
    statusVariant: 'warning',
    actionLabel: 'Review',
  ...
  },
  {
    ...
    creator: 'ADF',
    customer: 'Portland Facility',
    customerCode: 'PDX-7712',
    shipTo: 'Production Line',
  ...
  // Page 3 - Specialty Materials
  {
    ...
    creator: 'CPG',
    customer: 'Chicago Facility',
    customerCode: 'CHI-8801',
    shipTo: 'Enhanced Production Line',
  ...
  },
  {
    ...
    creator: 'CPD',
    customer: 'Indianapolis Facility',
  ...
  },
  {
    ...
    creator: 'RMA',
    customer: 'Kansas City Facility',
    customerCode: 'KCM-1102',
    shipTo: 'Processing Line',
  ...
  },
  {
    ...
    materialCode: 'RM-B-002',
    volume: 12.8,
    optimizedSource: 'Northwestern Plant',
    sourceType: 'plant',
    status: 'Pending',
    statusVariant: 'warning',
    actionLabel: 'Review',
...
export default function OrdersPage() {
  ...
  // Filter states (controlled by TopBar)
  const [regionFilter, setRegionFilter] = useState('All Regions');
  const [statusFilter, setStatusFilter] = useState('All status');
  const [materialFilter, setMaterialFilter] = useState('All Materials');

  // Handle TopBar filter changes
  const handleFilterChange = (filters: { region: string; timeFrame: string; material: string }) => {
  ...
  const filteredAndSortedData = useMemo(() => {
    ...
    // Apply region filter (from TopBar)
    ...
    // Apply material filter (from TopBar)
